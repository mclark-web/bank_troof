...
export const metadata: Metadata = {
  title: "Donations",
  description:
    "BankTruth is donation-supported. Gifts do not buy grades, advice, or a subscription.",
};
...
export default function DonatePage() {
  return (
    <LegalShell
      ...
      lede="BankTruth is not a paid advice service, a subscription tip sheet, or a product that sells scores. A gift, if one is accepted later, does not buy a grade."
    >
      <LegalSection id="what" title="What a donation is">
        <p>
          BankTruth is built to run on voluntary support. A donation is a gift to keep the site available. It is not a fee, not a subscription, and not payment for a recommendation. There is no paid tier, no tip line, and no grade you can purchase.
        </p>
        <p>
      ...
      <LegalSection id="does-not" title="What a donation does not buy">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>A tax deduction. Donations are not tax-deductible unless BankTruth later says so in a written notice. None is in effect.</li>
        </ul>
        <p>
