...
export type TickerSeed = {
  ...
  industry: string;
  exchange: string;
  /** Scales the seeded wiggle. Dollar levels come from split-adjusted anchors. */
  vol: number;
};
...
export const TICKERS: TickerSeed[] = [
  { symbol: "AAPL", name: "Apple", sector: "Technology", industry: "Consumer electronics", exchange: "NASDAQ", vol: 0.22 },
  { symbol: "MSFT", name: "Microsoft", sector: "Technology", industry: "Software", exchange: "NASDAQ", vol: 0.2 },
  { symbol: "NVDA", name: "NVIDIA", sector: "Technology", industry: "Semiconductors", exchange: "NASDAQ", vol: 0.46 },
  { symbol: "GOOGL", name: "Alphabet", sector: "Technology", industry: "Internet", exchange: "NASDAQ", vol: 0.24 },
  { symbol: "META", name: "Meta Platforms", sector: "Technology", industry: "Internet", exchange: "NASDAQ", vol: 0.34 },
  { symbol: "AMZN", name: "Amazon", sector: "Technology", industry: "Internet retail", exchange: "NASDAQ", vol: 0.28 },
  { symbol: "AVGO", name: "Broadcom", sector: "Technology", industry: "Semiconductors", exchange: "NASDAQ", vol: 0.36 },
  { symbol: "CRM", name: "Salesforce", sector: "Technology", industry: "Software", exchange: "NYSE", vol: 0.3 },
  { symbol: "ORCL", name: "Oracle", sector: "Technology", industry: "Software", exchange: "NYSE", vol: 0.26 },
  { symbol: "AMD", name: "AMD", sector: "Technology", industry: "Semiconductors", exchange: "NASDAQ", vol: 0.42 },
  { symbol: "JPM", name: "JPMorgan Chase", sector: "Financials", industry: "Banks", exchange: "NYSE", vol: 0.2 },
  { symbol: "GS", name: "Goldman Sachs Group", sector: "Financials", industry: "Capital markets", exchange: "NYSE", vol: 0.24 },
  { symbol: "BAC", name: "Bank of America", sector: "Financials", industry: "Banks", exchange: "NYSE", vol: 0.26 },
  { symbol: "V", name: "Visa", sector: "Financials", industry: "Payments", exchange: "NYSE", vol: 0.18 },
  { symbol: "MA", name: "Mastercard", sector: "Financials", industry: "Payments", exchange: "NYSE", vol: 0.18 },
  { symbol: "UNH", name: "UnitedHealth", sector: "Healthcare", industry: "Managed care", exchange: "NYSE", vol: 0.28 },
  { symbol: "LLY", name: "Eli Lilly", sector: "Healthcare", industry: "Pharmaceuticals", exchange: "NYSE", vol: 0.32 },
  { symbol: "JNJ", name: "Johnson & Johnson", sector: "Healthcare", industry: "Pharmaceuticals", exchange: "NYSE", vol: 0.16 },
  { symbol: "PFE", name: "Pfizer", sector: "Healthcare", industry: "Pharmaceuticals", exchange: "NYSE", vol: 0.24 },
  { symbol: "ABBV", name: "AbbVie", sector: "Healthcare", industry: "Pharmaceuticals", exchange: "NYSE", vol: 0.2 },
  { symbol: "XOM", name: "Exxon Mobil", sector: "Energy", industry: "Integrated oil", exchange: "NYSE", vol: 0.22 },
  { symbol: "CVX", name: "Chevron", sector: "Energy", industry: "Integrated oil", exchange: "NYSE", vol: 0.22 },
  { symbol: "COP", name: "ConocoPhillips", sector: "Energy", industry: "Exploration", exchange: "NYSE", vol: 0.28 },
  { symbol: "WMT", name: "Walmart", sector: "Consumer", industry: "Retail", exchange: "NYSE", vol: 0.16 },
  { symbol: "COST", name: "Costco", sector: "Consumer", industry: "Retail", exchange: "NASDAQ", vol: 0.18 },
  { symbol: "NKE", name: "Nike", sector: "Consumer", industry: "Apparel", exchange: "NYSE", vol: 0.3 },
  { symbol: "SBUX", name: "Starbucks", sector: "Consumer", industry: "Restaurants", exchange: "NASDAQ", vol: 0.26 },
  { symbol: "MCD", name: "McDonald's", sector: "Consumer", industry: "Restaurants", exchange: "NYSE", vol: 0.16 },
  { symbol: "HD", name: "Home Depot", sector: "Consumer", industry: "Retail", exchange: "NYSE", vol: 0.2 },
  { symbol: "PG", name: "Procter & Gamble", sector: "Consumer", industry: "Household products", exchange: "NYSE", vol: 0.14 },
  { symbol: "CAT", name: "Caterpillar", sector: "Industrials", industry: "Machinery", exchange: "NYSE", vol: 0.26 },
  { symbol: "GE", name: "GE Aerospace", sector: "Industrials", industry: "Aerospace", exchange: "NYSE", vol: 0.28 },
  { symbol: "BA", name: "Boeing", sector: "Industrials", industry: "Aerospace", exchange: "NYSE", vol: 0.38 },
  { symbol: "HON", name: "Honeywell", sector: "Industrials", industry: "Conglomerates", exchange: "NASDAQ", vol: 0.18 },
  { symbol: "NFLX", name: "Netflix", sector: "Media", industry: "Streaming", exchange: "NASDAQ", vol: 0.32 },
  { symbol: "DIS", name: "Disney", sector: "Media", industry: "Entertainment", exchange: "NYSE", vol: 0.26 },
  { symbol: "TMUS", name: "T-Mobile", sector: "Media", industry: "Telecom", exchange: "NASDAQ", vol: 0.2 },
];
